...
- Setting up IAM users, roles, and policies the right way
- Enabling CloudTrail, GuardDuty, and Security Hub
- Basic encryption with KMS and S3
- Protecting data with proper bucket policies and VPC security groups
